    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-5xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16 animate-fade-in">
          <button className="bg-blue-600 hover:bg-blue-700 text-white px-10 py-5 rounded-xl text-lg font-semibold transition-all transform hover:scale-105 shadow-xl">
            Discover HX50
          </button>
          <button className="border-2 border-white text-white hover:bg-white hover:text-gray-900 px-10 py-5 rounded-xl text-lg font-semibold transition-all transform hover:scale-105 backdrop-blur-sm">
            Watch Demo Flight
          </button>
        </div>
